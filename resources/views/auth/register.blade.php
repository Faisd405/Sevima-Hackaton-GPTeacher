<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-input.text-input id="name" class="block w-full mt-1" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
            <x-input.input-error :messages="$errors->get('name')" class="mt-2" />
        </div>

        <!-- Username Address -->
        <div class="mt-4">
            <x-input.input-label for="username" value="Username" />
            <x-input.text-input id="username" class="block w-full mt-1" type="text" name="username" :value="old('username')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-input.text-input id="email" class="block w-full mt-1" type="email" name="email" :value="old('email')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-input.text-input id="password_confirmation" class="block w-full mt-1"
                            type="password"
