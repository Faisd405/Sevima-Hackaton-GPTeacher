<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div>
            ...
            <x-input.text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-input.text-input id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="new-password" />
